...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "0xeea0eef1b29d48928c3b527cd750f34f"
...
#define AI_TOOLS_DATE_TIME   "Tue Apr 30 17:06:10 2024"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 3460, 1, 1),
    3460, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_OUT_NUM, &gemm_4_output),
  &gemm_0_layer, 0xacdcb7aa, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_sine_model_activations_map, 1, params)) {
    ...
    nl_2_nl_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 64);
    nl_2_nl_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 64);
    gemm_3_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 0);
    gemm_3_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 0);
    nl_3_nl_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 64);
    nl_3_nl_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 64);
    gemm_4_output_array.data = AI_PTR(g_sine_model_activations_map[0] + 0);
    gemm_4_output_array.data_start = AI_PTR(g_sine_model_activations_map[0] + 0);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_sine_model_weights_map, 1, params)) {
    ...
    gemm_2_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 2240);
    gemm_2_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 2240);
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_sine_model_weights_map[0] + 2304);
    gemm_3_weights_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 2304);
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 3328);
    gemm_3_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 3328);
    gemm_4_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_weights_array.data = AI_PTR(g_sine_model_weights_map[0] + 3392);
    gemm_4_weights_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 3392);
    gemm_4_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 3456);
    gemm_4_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 3456);
    return true;
  }

...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "8851d6e4b47e23cee7a0101d94f0d8ee"
...
#define AI_TOOLS_DATE_TIME   "Tue Apr 30 18:14:56 2024"
...
AI_STATIC ai_array dense_0_weights_array;   /* Array #12 */
AI_STATIC ai_array dense_0_bias_array;   /* Array #13 */
AI_STATIC ai_array dense_1_weights_array;   /* Array #14 */
AI_STATIC ai_array dense_1_bias_array;   /* Array #15 */
AI_STATIC ai_array dense_2_weights_array;   /* Array #16 */
AI_STATIC ai_array dense_2_bias_array;   /* Array #17 */
AI_STATIC ai_array dense_3_weights_array;   /* Array #18 */
AI_STATIC ai_array dense_3_bias_array;   /* Array #19 */
AI_STATIC ai_array dense_4_weights_array;   /* Array #20 */
AI_STATIC ai_array dense_4_bias_array;   /* Array #21 */
AI_STATIC ai_array dense_5_weights_array;   /* Array #22 */
AI_STATIC ai_array dense_5_bias_array;   /* Array #23 */
...
AI_STATIC ai_tensor dense_0_weights;   /* Tensor #12 */
AI_STATIC ai_tensor dense_0_bias;   /* Tensor #13 */
AI_STATIC ai_tensor dense_1_weights;   /* Tensor #14 */
AI_STATIC ai_tensor dense_1_bias;   /* Tensor #15 */
AI_STATIC ai_tensor dense_2_weights;   /* Tensor #16 */
AI_STATIC ai_tensor dense_2_bias;   /* Tensor #17 */
AI_STATIC ai_tensor dense_3_weights;   /* Tensor #18 */
AI_STATIC ai_tensor dense_3_bias;   /* Tensor #19 */
AI_STATIC ai_tensor dense_4_weights;   /* Tensor #20 */
AI_STATIC ai_tensor dense_4_bias;   /* Tensor #21 */
AI_STATIC ai_tensor dense_5_weights;   /* Tensor #22 */
AI_STATIC ai_tensor dense_5_bias;   /* Tensor #23 */
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_dense_21_input0_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, &serving_default_dense_21_input0_output_array, NULL)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_OUT_NUM, &dense_5_output),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    nl_3_nl_output_array.data = AI_PTR(activations + 0);
    nl_3_nl_output_array.data_start = AI_PTR(activations + 0);
    dense_4_output_array.data = AI_PTR(activations + 64);
    dense_4_output_array.data_start = AI_PTR(activations + 64);
    nl_4_nl_output_array.data = AI_PTR(activations + 0);
    nl_4_nl_output_array.data_start = AI_PTR(activations + 0);
    dense_5_output_array.data = AI_PTR(NULL);
    dense_5_output_array.data_start = AI_PTR(NULL);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_2_bias_array.data = AI_PTR(weights + 2240);
    dense_2_bias_array.data_start = AI_PTR(weights + 2240);
    dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_weights_array.data = AI_PTR(weights + 2304);
    dense_3_weights_array.data_start = AI_PTR(weights + 2304);
    dense_3_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_bias_array.data = AI_PTR(weights + 3328);
    dense_3_bias_array.data_start = AI_PTR(weights + 3328);
    dense_4_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_4_weights_array.data = AI_PTR(weights + 3392);
    dense_4_weights_array.data_start = AI_PTR(weights + 3392);
    dense_4_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_4_bias_array.data = AI_PTR(weights + 4416);
    dense_4_bias_array.data_start = AI_PTR(weights + 4416);
    dense_5_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_5_weights_array.data = AI_PTR(weights + 4480);
    dense_5_weights_array.data_start = AI_PTR(weights + 4480);
    dense_5_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_5_bias_array.data = AI_PTR(weights + 4544);
    dense_5_bias_array.data_start = AI_PTR(weights + 4544);
  }
